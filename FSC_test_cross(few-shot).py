...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./Test_out/Focal_Mod_CounTRweight_chk550/',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./Test_out/Focal_Mod_CounTRweight_chk550/log_files/',
                        help='path where to tensorboard log')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=0, type=int)
    parser.add_argument('--resume', default='./data/out/Focal_Mod_New_v7_after_v4/fim6_dir/checkpoint__finetuning_550.pth',
