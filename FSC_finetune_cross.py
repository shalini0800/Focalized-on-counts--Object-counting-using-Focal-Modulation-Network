...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./data/out/Focal_Mod_New_v7_after_v4/fim6_dir',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=0, type=int)
    parser.add_argument('--resume', default='/media/homes/vivek/CounTR-main_Shalini/data/out/Model_v1/pre_4_dir/checkpoint__pretraining_499.pth',
    ...
    # Logging parameters
    parser.add_argument('--log_dir', default='./data/out/Focal_Mod_New_v7_after_v4/logs/fim6_dir',
...
def main(args):
    ...
    if global_rank == 0:
        ...
        if args.wandb is not None:
            wandb_run = wandb.init(
                config=args,
                resume="allow",
                project="objectcounting_uni_hildesheim_2023",
                name=args.title,
                entity="vivekverma1018",
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for data_iter_step, (samples, gt_density, boxes, m_flag) in enumerate(
            ...
            if (data_iter_step == 0) and (epoch % 20 == 0 or epoch + 1 == args.epochs):
                if log_writer is not None:
