...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=(384, 384), patch_size=4, in_chans=3, embed_dim=96, use_conv_embed=False, norm_layer=None, is_stem=False):
        super().__init__()
...
def focalnet_base_iso(pretrained=False, **kwargs):
    ...
    checkpoint = torch.load('./data/out/Focal_Mod_New_v7_after_v4/fim6_dir/checkpoint__finetuning_minMAE.pth', map_location='cpu')
