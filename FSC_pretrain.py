...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./data/out/Focal_Mod_New_v7/pre_4_dir',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=0, type=int)
    parser.add_argument('--resume', default='./data/out/Focal_Mod_New_v5_after_v4/pre_4_dir/checkpoint__pretraining_499.pth',  # mae_visualize_vit_base
    ...
    # Logging parameters
    parser.add_argument('--log_dir', default='./logs/Focal_Mod_New_v7/pre_4_dir',
